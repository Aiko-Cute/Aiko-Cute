...
pre_install_docker_compose() {
    ...
    read -p "Nhập CLOUDFLARE_EMAIL :" CLOUDFLARE_EMAIL
    echo -e "CLOUDFLARE_EMAIL = ${CLOUDFLARE_EMAIL}"

    read -p "Nhập CLOUDFLARE_API_KEY :" CLOUDFLARE_API_KEY
    echo -e "CLOUDFLARE_API_KEY = ${CLOUDFLARE_API_KEY}"
}
