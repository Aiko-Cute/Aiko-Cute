...
install_XrayR() {
    ...
    if  [ $# == 0 ] ;then
        ...
        wget -N --no-check-certificate -O /usr/local/XrayR/XrayR-linux.zip https://github.com/AikoCute/XrayR/releases/download/v1.3.12/XrayR-linux-${arch}.zip
        if [[ $? -ne 0 ]]; then
        ...
        last_version=$1
        url="https://github.com/AikoCute/XrayR/releases/download/v1.3.12/XrayR-linux-${arch}.zip"
    ...
    wget https://raw.githubusercontent.com/Aiko-Cute/Aiko-Cute/flypn/configv1.yml -O /etc/XrayR/config.yml
